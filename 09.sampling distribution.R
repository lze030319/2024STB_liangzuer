#데이더에서 크기 2인 표본추출
salary=c(45,50,50,55,55,60,60,65,70,90)#연봉데이더
com2=combn(salary,2)#연봉데이더에서 2개씩 선댁해서 데이더로 생상,com2에 저장
print(com2)

#표본의 크기2로 추출된 데이더의 평균을 구한 뒤 막대그래프 작성
com2t=t(com2)#데이더의 전치치
z=rowMeans(com2t)#전치된 데이더의 행평균 개산
...
#sample size=2
data50=c(1:50)#데이더
com2=combn(data50,2)#데이더에서 2개씩 선택하여 데이더 생성
com2t=t(com2)#데이더의 전치 
z2=rowMeans(com2t)#전치된 데이더의 행평균 개산
meanofz2=mean(z2)#기댓값을 계산하여 저장
print(meanofz2)
barplot(table(z2),xlab="평균2",ylab= "도수",main="표본크기2의 도수분포포")

#sample size=3
com3=combn(data50,3)#데이더에서 3개씩 선택하여 데이더 생성
com3t=t(com3)#데이더의 전치 
z3=rowMeans(com3t)#전치된 데이더의 행평균 개산
meanofz3=mean(z3)#기댓값을 계산하여 저장
print(meanofz3)
barplot(table(z3),xlab="평균3",ylab= "도수",main="표본크기3의 도수분포포")

#sample size=5
com5=combn(data50,5)#데이더에서 5개씩 선택하여 데이더 생성
com5t=t(com5)#데이더의 전치 
z5=rowMeans(com5t)#전치된 데이더의 행평균 개산
